        ...
        {activeTab === "mood" && (
          <div className="bg-white rounded-2xl shadow-lg p-8 mb-6">
            ...
            <div className="grid grid-cols-2 gap-4 max-w-md mx-auto">
              <button
                onClick={() => handleMoodSelect("热闹 开心 欢快 聚餐")}
                className="p-6 rounded-xl bg-gradient-to-br from-yellow-400 to-orange-500 text-white font-semibold hover:shadow-lg transition-all hover:scale-105"
              >
                <div className="text-3xl mb-2">🎉</div>
                热闹开心
              </button>
              <button
                onClick={() => handleMoodSelect("浪漫 约会 氛围 适合拍照")}
                className="p-6 rounded-xl bg-gradient-to-br from-pink-400 to-rose-500 text-white font-semibold hover:shadow-lg transition-all hover:scale-105"
              >
                <div className="text-3xl mb-2">💕</div>
                浪漫约会
              </button>
              <button
                onClick={() => handleMoodSelect("安静 放松 舒适 适合工作")}
                className="p-6 rounded-xl bg-gradient-to-br from-blue-400 to-indigo-500 text-white font-semibold hover:shadow-lg transition-all hover:scale-105"
              >
                <div className="text-3xl mb-2">🍃</div>
                安静放松
              </button>
              <button
                onClick={() => handleMoodSelect("治愈 一个人 发呆 安静")}
                className="p-6 rounded-xl bg-gradient-to-br from-green-400 to-teal-500 text-white font-semibold hover:shadow-lg transition-all hover:scale-105"
              >
                <div className="text-3xl mb-2">🌿</div>
                治愈独处
              </button>
